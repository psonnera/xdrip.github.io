...
[What is xDrip+](#what-is-xdrip)?

## How to install xDrip+

[Prerequisites](../install/#prerequisites)  
[Which one to install](../install/#which-one-to-install)?  
[Install xDrip+](../install/#install-xdrip_1)  
[Select your data source](../install/#select-your-data-source) 
...
[DexDrip](https://github.com/StephenBlackWasAlreadyTaken/DexDrip)  was created by Emma Black in 2014 and then became [xDrip](http://stephenblackwasalreadytaken.github.io/xDrip/), an app collecting CGM data from a Dexcom G4 transmitter or a Wixel and sending them to [Nightscout](https://nightscout.github.io/).  It also came with the follower app [Nightwatch](http://stephenblackwasalreadytaken.github.io/xDrip/).
